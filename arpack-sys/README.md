...
64-bit-pointer-width targets only. 32-bit targets fail at compile time with `compile_error!` — 32-bit ARPACK use cases are out of scope for this crate. Open an issue if you need 32-bit support.
